    ...
    <StyledTable aria-label="simple table">
      <TableHead>
        <TableRow>
          ...
          <TableCell align="left">{<FormattedMessage id="event.inductionRoute" />}</TableCell>
          <TableCell align="left">
            {<FormattedMessage id="eventInductionForm.nbCellules" />}
          </TableCell>
          ...
          eventsData.map(row => {
            return (
              <TableRow key={row.id}>
                ...
                <TableCell align="left">{row.nb_cell}</TableCell>
                <TableCell align="left">
                  {!disabledBtn ? (
                    <>
                      <IconButton
