...
const EventArrayFacs = ({ disabledBtn, handleView, eventsData, handleModify, handleDelete }) => {
  return (
    <StyledTable aria-label="simple table">
      <TableHead>
        <TableRow>
          ...
          <TableCell align="left">{<FormattedMessage id="eventArrayFacs.panels" />}</TableCell>
                    ...
                    row.panels.map(panel => {
                      return (
                        <div>
                          ...
                          {panel.antibody_names &&
                            panel.antibody_names.map((antibody, index) => (
                              <div style={{ marginBottom: '10px', marginLeft: '50px' }}>
                                <div>
                                  <b>
