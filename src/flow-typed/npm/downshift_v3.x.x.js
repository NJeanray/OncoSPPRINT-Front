// flow-typed signature: 5129f7ce958350b1c729a1225c4697f6
...
declare module 'downshift' {
  ...
  declare export type PropGetters<Item> = {
    getRootProps: (options?: GetRootPropsOptions, otherOptions?: GetPropsCommonOptions) => { ... },
    getToggleButtonProps: (options?: GetToggleButtonPropsOptions) => { ... },
    getLabelProps: (options?: GetLabelPropsOptions) => { ... },
    getMenuProps: (options?: GetMenuPropsOptions, otherOptions?: GetPropsCommonOptions) => { ... },
  ...
  declare export type Actions<Item> = {
    reset: (otherStateToSet?: PartialStateChangeOptions<Item>, cb?: Callback) => mixed,
    openMenu: (cb?: Callback) => mixed,
    closeMenu: (cb?: Callback) => mixed,
    toggleMenu: (otherStateToSet?: PartialStateChangeOptions<Item>, cb?: Callback) => mixed,
    selectItem: (
      item: Item,
  ...
  declare export type DownshiftProps<Item> = $ReadOnly<{|
    ...
    onChange?: (selectedItem: ?Item, stateAndHelpers: ControllerStateAndHelpers<Item>) => mixed,
    onSelect?: (selectedItem: ?Item, stateAndHelpers: ControllerStateAndHelpers<Item>) => mixed,
    onStateChange?: (
  ...
  declare export default class Downshift<Item> extends React$Component<DownshiftProps<Item>> {
