...
declare module 'axios' {
  ...
  declare type AxiosTransformer<T> = (data: T, headers?: { [key: string]: mixed, ... }) => mixed
  ...
  declare type AxiosAdapter = (config: AxiosXHRConfig<mixed>) => Promise<AxiosXHR<mixed>>
  ...
  declare class Axios {
    ...
    options<R>(url: string, config?: AxiosXHRConfigBase<mixed, R>): AxiosPromise<mixed, R>;
